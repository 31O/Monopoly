...
public class Monopoly {
            ...
            while (playerMoney[i] > 0) {
                for (int j = 0; j < playerCount; j++) {
                    ...
                    if ((playerTurnInput.equals("") || playerTurnInput.equalsIgnoreCase("money") ||
                            playerTurnInput.equalsIgnoreCase("sell")) && !inJailStatus[j]) {
                        ...
                        if (mediterraneanAveOwnership[j] != 0 && balticAveOwnership[j] != 0 &&
                            ...
                            switch (buildOnWhichProperty) {
                                case "mediterranean avenue":
                                    ...
                                    if ((propertyHouses[2][0] && !propertyHouses[4][0]) || //switch cases with only 2 cases don't call a method to check for houses, rest do
                                        ...
                                        propertyHouses = housesCreator(propertyPositionCase1, hotelOwnership, propertyHouses);
                                    }
                                    break;
                                ...
                                case "baltic avenue":
                                    ...
                                    if ((!propertyHouses[2][0] && propertyHouses[4][0]) ||
                                        ...
                                        propertyHouses = housesCreator(propertyPositionCase2, hotelOwnership, propertyHouses);
                                    }
                                    break;
                            ...
                            switch (buildOnWhichProperty) {
                                ...
                                case "connecticut avenue":
                                    ...
                                    if (ifEligible) {
                                        ...
                                        propertyHouses = housesCreator(propertyPositionCase3, hotelOwnership, propertyHouses);
                                    }
                                    break;
                    ...
                    } else if (playerTurnInput.equalsIgnoreCase("card") && jailCardOwned[j]) {
    ...
    public static boolean[][] housesCreator(byte propertyPosition, boolean[] hotelOwnership, boolean[][] propertyHouses) {
